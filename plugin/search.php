...
<?php
    ...
    if(strlen($query) >= $min_length){
        ...
        $raw_results = mysql_query("SELECT * FROM posts
            WHERE (`title` LIKE '%".$query."%') OR (`category` LIKE '%".$query."%') OR (`body` LIKE '%".$query."%') OR (`author` LIKE '%".$query."%')") or die(mysql_error());
     ...
     if ($results['recimg'] == "no") {
                    ...
                    ?>
                 <div class='h1'  style='background-image: url(img/<?php echo $results['recimg'];?>);'><a href="post.php?pid=<?php echo $row['id'];?>"></a>
     <div class='h2'>
                  ...
                  <section id="right" class="row">
                    <div>
                        ...
                        <ul class="posts col-xs-12 col-sm-12 col-lg-12 col-md-12">
                          ...
                          $result=mysql_query(" SELECT * FROM posts ORDER BY RAND() LIMIT 4");
